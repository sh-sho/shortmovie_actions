...
#                 break
#             else:
#                 output_filename = '{}_{}_{:.2f}.jpg'.format(
#                     base_filename, str(frame_idx).zfill(digit), current_sec
#                 )
...
#     prompt = HumanMessage(
#         content=[
#             {"type": "text", "text": "Convert the text into a specific sentence like 'In the background, there are tall, rugged mountains with some tree cover, enhancing the scenic beauty of the location. The presence of a church tower with a pointed roof adds a historic and cultural touch to the town. The overall scene is serene, capturing the essence of a peaceful lakeside settlement.'."},
